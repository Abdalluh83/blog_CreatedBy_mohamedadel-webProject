...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="dist/img/AdminLTELogo.jpg" alt="AdminLTELogo" height="300" width="300">
  </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php $p=0 ;foreach ($my_posts as $pp) { $p++; } echo $p;?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php $l=0 ;foreach ($all_likes as $like) { $l++; } echo $l;?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><?php $x=0 ;foreach ($all_users as $user) { $x++; } echo $x;?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3><?php $r=0 ;foreach ($all_comment as $c) { $r++; } echo $r;?></h3>
